...
export const GET_OFFERS_URL = WEBSITE_URL + "/public/api/get-offers";
...
export const GET_MEAT_CATEGORIES_URL = WEBSITE_URL + "/public/api/get-meats-categories";
export const GET_CATEGORY_ITEMS_URL = WEBSITE_URL + "/public/api/get-category-items";
...
export const GET_CART_COUPON_URL = WEBSITE_URL + "/public/api/get-cart-coupon";
export const USER_COUPON_URL = WEBSITE_URL + "/public/api/user-coupons";
export const LOGIN_USER_URL = WEBSITE_URL + "/public/api/login";
export const REGISTER_USER_URL = WEBSITE_URL + "/public/api/register";
export const DELETE_MY_ACCOUNT_URL = WEBSITE_URL + "/public/api/delete-my-account";
...
export const PAYU_CREATE_ORDER_URL = WEBSITE_URL + "/public/api/payment/payu/create-order";
export const PAYU_PROCESS_VERIFY_URL = WEBSITE_URL + "/public/api/payment/verify-payu-money";

export const PHONEPE_CREATE_ORDER_URL = WEBSITE_URL + "/public/api/payment/phonepe/create-order";

export const PAYTM_PAYMENT_URL = WEBSITE_URL + "/public/api/payment/paytm";
export const UPI_GATEWAY_PAYMENT_URL = WEBSITE_URL + "/public/api/payment/upi-gateway";
...
export const GENERATE_OTP_FOR_PHONE_NUMBER_UPDATE_URL = WEBSITE_URL + "/public/api/generate-otp-phone-number-update";
export const UPDATE_NEW_PHONE_NUMBER_URL = WEBSITE_URL + "/public/api/update-new-phone-number";
