...
import DesktopLoginPopup from "./LoginPopup";

class V2 extends Component {
	render() {
		return (
			<React.Fragment>
				<div className="_1TWur snipcss-7kiwP">
					<div className="_2COmU">
					<div className="m3-34">
						<div className="_2TYHu">
						<svg width={200} className="_1envo" viewBox="0 0 200 200">
						...
						<div className="_3mZgT">
						<div className="Al5GE">
							<div className="_3Um38 _2oQ4_">
							<input type="text" className="_381fS _1oTLG _3BIgv" name="location" id="location" autoComplete="off" tabIndex={1} placeholder="Enter your delivery location" maxLength={30} />
							<div className="_2EeI1 _26LFr">
							</div>
							<label className="_1Cvlf _2tL9P" htmlFor="location">
							</label>
							</div>
							<button className="_1fiQt">
							<span className="icon-location-crosshair _25lQg">
							</span>
							<span className="LukWG">
								Locate Me
							</span>
							</button>
						</div>
					...
					<div className="_2h2bu" style={{backgroundImage: 'url("https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,h_1340/Lunch1_vlksgq")'}}>
					</div>
				</div>
				<div className="_2tnu- snipcss-lmZtk">
				<div className="_2RZDN">
				  <div className="_2Zn3W">
					<div className="_1Vw_y">
					  <img className="_2dYjq" width={105} height={199} src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_210,h_398/4x_-_No_min_order_x0bxuf" />
					</div>
					<div className="_3fted">
					  No Minimum Order
					</div>
				  ...
				  <div className="_2Zn3W">
					<div className="_1Vw_y">
					  <img className="_2dYjq" width={112} height={206} src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_224,h_412/4x_Live_order_zzotwy" />
					</div>
					<div className="_3fted">
					  Live Order Tracking
					</div>
				  ...
				  <div className="_2Zn3W">
					<div className="_1Vw_y">
					  <img className="_2dYjq" width={124} height={188} src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_248,h_376/4x_-_Super_fast_delivery_awv7sn" />
					</div>
					<div className="_3fted">
			  ...
			  <div className="_3tAmb snipcss-7Dwse">
			  <div className="_2ZpEk">
				<div className="_221uw">
				...
				<div>
				  <a href="https://play.google.com/store/apps/details?id=in.swiggy.android" target="_blank" rel="noopener noreferrer">
					<img className="_12dJy" height={54} src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,h_108/play_ip0jfp" />
				  </a>
				  <a href="https://itunes.apple.com/in/app/swiggy-food-order-delivery/id989540920" target="_blank" rel="noopener noreferrer">
					<img className="_37Cft" height={54} src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,h_108/iOS_ajgrty" />
				  </a>
				</div>
				<img className="_3QGpR" width={384} height={489} src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_768,h_978/pixel_wbdy4n" />
				<img className="_2SJnz" width={384} height={489} src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_768,h_978/iPhone_wgconp_j0d1fn" />
			  </div>
			</div>
			<div className="d_rQj snipcss-BOTNW">
			<div className="_25jJQ">
			  <div className="_3ipKA">
				<div className="_2Im4A">
				  ...
				  <ul className="_2gbMt">
					...
					<li className="b-Hy9">
					  <a className="_3TjLz" href="https://blog.swiggy.com" rel="nofollow noopener" alt="" target="_blank">
						Swiggy Blog
					  </a>
					</li>
					<li className="b-Hy9">
					  <a className="_3TjLz" href="/bug-bounty" rel="nofollow noopener" alt="" target="_blank">
						Bug Bounty
					  </a>
					</li>
					<li className="b-Hy9">
					  <a className="_3TjLz" href="/swiggy-super" rel="nofollow noopener" alt="" target="_blank">
						Swiggy One
					  </a>
					</li>
					<li className="b-Hy9">
					  <a className="_3TjLz" href="https://corporate.swiggy.com" rel="nofollow noopener" alt="" target="_blank">
						Swiggy Corporate
					  </a>
					</li>
					<li className="b-Hy9">
					  <a className="_3TjLz" href="/swiggy-instamart" rel="nofollow noopener" alt="" target="_blank">
						Swiggy Instamart
					  </a>
					</li>
					<li className="b-Hy9">
					  <a className="_3TjLz" href="/swiggy-genie" rel="nofollow noopener" alt="" target="_blank">
						Swiggy Genie
					  </a>
					</li>
				  </ul>
				...
				<div className="_2Im4A">
				  ...
				  <ul className="_2gbMt">
					...
					<li className="b-Hy9">
					  <a className="_3TjLz" href="https://partner-with-us.swiggy.com/onboard#/swiggy" rel="nofollow noopener noreferrer" alt="" target="_blank">
						Partner with us
					  </a>
					</li>
					<li className="b-Hy9">
					  <a className="_3TjLz" href="https://ride.swiggy.com/" rel="nofollow noopener" alt="" target="_blank">
						Ride with us
					  </a>
					</li>
				  </ul>
				...
				<div className="_2Im4A">
				  ...
				  <ul className="_2gbMt">
					<li className="b-Hy9">
					  <a className="_3TjLz" href="/terms-and-conditions" alt="" target="_blank">
						Terms &amp; Conditions
					  </a>
					</li>
					<li className="b-Hy9">
					  <a className="_3TjLz" href="/refund-policy" alt="" target="_blank">
						Refund &amp; Cancellation
					  </a>
					</li>
					<li className="b-Hy9">
					  <a className="_3TjLz" href="/privacy-policy" alt="" target="_blank">
						Privacy Policy
					  </a>
					</li>
					<li className="b-Hy9">
					  <a className="_3TjLz" href="/cookie-policy" alt="" target="_blank">
						Cookie Policy
					  </a>
					</li>
					<li className="b-Hy9">
					...
					<li className="b-Hy9">
					  <a className="_3TjLz" href="/beware-of-phishing-and-fraud" alt="" target="_blank">
						Phishing &amp; Fraud
					  </a>
					</li>
					<li className="b-Hy9">
					  <a className="_3TjLz" href="/tnc-corporate-sm" alt="" target="_blank">
						Corporate – Swiggy Money Codes Terms and Conditions
					  </a>
					</li>
					<li className="b-Hy9">
					  <a className="_3TjLz" href="/tnc-corporate-discount" alt="" target="_blank">
				...
				<div className="_1Jvc1">
				  <a href="https://itunes.apple.com/in/app/id989540920?referrer=utm_source%3Dswiggy%26utm_medium%3Dhomepage" rel="nofollow noopener" alt="" target="_blank" className="AppDownloadLinks_appLink__3lQqz" data-testid="ios-appstore">
					<img alt="" src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_200,h_65/icon-AppStore_lg30tv" />
				  </a>
				  <a href="https://play.google.com/store/apps/details?id=in.swiggy.android&referrer=utm_source%3Dswiggy%26utm_medium%3Dheader" rel="nofollow noopener" alt="" target="_blank" className="AppDownloadLinks_appLink__3lQqz" data-testid="android-playstore">
					<img alt="" src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_200,h_65/icon-GooglePlay_1_zixjxl" />
				  </a>
				</div>
			  </div>
			  <div id="city-links" className="RB8ET">
				<h4 className="T_dbb">
				  WE DELIVER TO
				</h4>
				<div className="_1_sSy">
				  ...
				  <ul className="_1w9D3">
					...
					<li className="_2JILy">
					  <a className="_3TjLz b-Hy9" href="/city/deoria">
						deoria
					  </a>
					</li>
					<li className="_2JILy">
				  ...
				  <ul className="_1w9D3">
					<li className="_2JILy">
					  <a className="_3TjLz b-Hy9" href="/city/khatauli-2">
						khatauli-2
					  </a>
					</li>
					<li className="_2JILy">
					  <a className="_3TjLz b-Hy9" href="/city/khopoli">
						khopoli
					  </a>
					</li>
					<li className="_2JILy">
				  ...
				  <ul className="_1w9D3">
					...
					<li className="_2JILy">
					  <a className="_3TjLz b-Hy9" href="/city/puttur-karnataka">
						puttur-karnataka
					  </a>
					</li>
				  </ul>
			  ...
			  <div className="_3zqGM">
				<div className="_26WmF">
				  <a href="/">
					<img className width={142} alt="" src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_284/Logo_f5xzza" />
				  </a>
				</div>
				<div className="_2BWW_">
				  © 2023 Swiggy
				</div>
				<div className="_2-f1I">
				  <a className="_1Az3W" href="https://www.facebook.com/swiggy.in" rel="nofollow noopener" alt="facebook" target="_blank">
					<img className width={24} height={24} alt="" src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_48,h_48/icon-facebook_tfqsuc" />
				  </a>
				  <a className="_1Az3W" href="https://pinterest.com/swiggyindia" rel="nofollow noopener" alt="pintrest" target="_blank">
					<img className width={24} height={24} alt="" src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_48,h_48/icon-pinterest_kmz2wd" />
				  </a>
				  <a className="_1Az3W" href="https://instagram.com/swiggyindia/" rel="nofollow noopener" alt="instagram" target="_blank">
					<img className width={24} height={24} alt="" src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_48,h_48/icon-instagram_b7nubh" />
				  </a>
				  <a className="_1Az3W" href="https://twitter.com/swiggy" rel="nofollow noopener" alt="twitter" target="_blank">
					<img className width={24} height={24} alt="" src="https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_48,h_48/icon-twitter_gtq8dv" />
				  </a>
				</div>
			  </div>
			</div>
