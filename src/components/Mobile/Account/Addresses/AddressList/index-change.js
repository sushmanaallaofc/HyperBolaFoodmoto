						...
						>
							...
							{!this.props.fromCartPage && this.props.deleteButton && (
								<React.Fragment>
									{user.data.default_address_id !== address.id && (
										<React.Fragment>
											<div className="_1cdSC">
												<span className="_2HLpnselect" onClick={(e) => this.handleSetDefaultAddress(e, address)}>SELECT</span>
												<span className="_2HLpn" onClick={this.handleDropdown}>DELETE</span>
											</div>
										</React.Fragment>
									)}
								</React.Fragment>
