										...
										{new_orders.map((order) => (
											...
											>
												<div className="delivery-list-item px-15 pb-5 pt-15">
													<div className="d-flex justify-content-between newOrderTimeEarning">
														<div>
															<p className="m-0 newOrderTimeAgo">
														...
														<div>
															{localStorage.getItem("enableDeliveryGuyEarning") ===
																"true" && (
																<p className="m-0 list-delivery-commission newOrderEarning">
